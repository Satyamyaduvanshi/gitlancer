    ...
    <DashboardLayout>
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* 📂 Animated Left Side: Repo Selector (Col-span 2) */}
          <motion.div variants={itemVariants} className="lg:col-span-2 bg-[#111111] border border-white/5 rounded-[2rem] shadow-2xl p-6 flex flex-col h-[600px] relative overflow-hidden">
          ...
          {/* ⚡ Animated Right Side: Command Center (Col-span 1) */}
          <motion.div variants={itemVariants} className="lg:col-span-1 flex flex-col justify-between bg-[#111111] border border-white/5 rounded-[2rem] shadow-2xl p-6 h-fit lg:sticky lg:top-6">
