  ...
  return (
    <DashboardLayout>
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col md:flex-row gap-4 items-center justify-between mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {isLoading ? (
            ...
            <motion.div 
              variants={itemVariants} // 🛡️ Adds the stagger effect to each card
              key={vault.id} 
