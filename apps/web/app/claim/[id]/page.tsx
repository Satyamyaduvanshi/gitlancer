  ...
  return (
    <main className="flex flex-col min-h-screen bg-[#0A0A0A] text-white font-sans selection:bg-persimmon/30 relative overflow-hidden">
      ...
      >
        ...
        {/* Top Navigation */}
        <motion.nav variants={itemVariants} className="w-full p-6 flex items-center justify-between relative z-20">
        ...
        <div className="flex-1 flex items-center justify-center p-4 md:p-8 w-full">
          ...
          <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-5 gap-6 p-3 rounded-[2.5rem] bg-black/20 border border-white/5 shadow-[0_8px_30px_rgb(0,0,0,0.06)] backdrop-blur-3xl">
            
            {/* 🚀 LEFT COLUMN: The Action Card */}
            <motion.div variants={itemVariants} className="md:col-span-3 bg-[#111111] rounded-[2rem] border border-white/5 shadow-2xl relative transform transition-all duration-500 hover:shadow-[0_20px_40px_rgba(0,0,0,0.4)] flex flex-col overflow-hidden">
                ...
                <AnimatePresence>
                  {status && status !== "Loading bounty data..." && status !== "" && !needsToLink && (
                    <motion.div 
                      ...
                      className={`text-center text-xs font-mono p-4 rounded-xl border break-words relative z-10 transition-all duration-500 ${
            ...
            <div className="md:col-span-2 flex flex-col gap-6">
              ...
              <motion.div variants={itemVariants} className="bg-persimmon/40 rounded-[2rem] border border-black/20 shadow-2xl p-8 flex flex-col justify-between group transition-all duration-500 hover:border-white/20 hover:shadow-[0_20px_40px_rgba(0,0,0,0.3)] hover:-translate-y-1">
              ...
              <motion.div variants={itemVariants} className={`bg-[#111111] rounded-[2rem] border border-white/5 shadow-2xl p-8 flex flex-col justify-between group transition-all duration-500 hover:border-white/20 hover:shadow-[0_20px_40px_rgba(0,0,0,0.3)] hover:-translate-y-1 ${pendingBounties.length > 0 ? '' : 'flex-1'}`}>
                <div className="flex items-center justify-between mb-6">
              ...
              {pendingBounties.length > 0 && (
                <motion.div variants={itemVariants} className="bg-[#111111] rounded-[2rem] border border-white/5 shadow-2xl p-6 flex flex-col gap-4 overflow-hidden flex-1">
        ...
        <motion.button variants={itemVariants} className="fixed bottom-6 right-6 p-3 bg-[#111111] border border-white/10 rounded-full text-persimmon hover:text-white hover:border-white/30 transition-all duration-300 z-50 group shadow-lg">
