  ...
  return (
    <DashboardLayout>
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 bg-background rounded-2xl border border-black/5 dark:border-white/5 p-4 shadow-sm">
        ...
        {/* 📋 Ledger Table Card */}
        <motion.div variants={itemVariants} className="bg-background rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] border border-black/5 dark:border-white/5 overflow-hidden">
                          ...
                          {isExpanded && (
                            <tr>
                              <td colSpan={5} className="p-0 border-b border-black/5 dark:border-white/5 bg-background">
                                ...
                                >
                                  <div className="p-5 m-3 rounded-2xl bg-black/5 dark:bg-black/20 border border-black/10 dark:border-white/5 flex flex-col gap-3 shadow-inner relative">
